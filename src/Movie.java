/*
 * Movie objects represent a single movie and store details such as genre, director, etc.
 * Used in conjunction with MovieDatabase to easily store/retrieve movie data
 */
